...
import { DeleteSGAPI } from '../APIs/SG/DeleteSGAPI';
import { EditSGWidget } from './EditSGWidget';
...
const SGManagement = () => {
  ...
  const handleaddDepartment = (newDepartment) => {
    ...
    const projectArray = [
      newDepartment._id,
      newDepartment.Studiengangsname,
      newDepartment.ModuleSem1,
      newDepartment.ModuleSem2,
    ...
    setState(prevState => ({
      ...
      allPersonnel: prevState.allPersonnel.map((department) => {
        if (department[0] === configuredDepartment._id) {
          return [
            department[0],
            configuredDepartment.Studiengangsname,
            configuredDepartment.ModuleSem1,
            configuredDepartment.ModuleSem2,
            configuredDepartment.ModuleSem3,
            configuredDepartment.ModuleSem4,
            configuredDepartment.ModuleSem5,
            configuredDepartment.ModuleSem6,
          ];
        }
        return department;
      }),
            ...
            <table className="table text-start align-middle table-bordered table-hover mb-0">
              <thead>
                <tr className="text-dark">
                  ...
                  <th scope="col">Studiengangsname</th>
