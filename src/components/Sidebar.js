    ...
    <div className="sidebar pe-3 pb-3">
      <nav className="navbar bg-light navbar-light">
        ...
        <div className="d-flex align-items-center ms-4 mb-4">
          ...
          <div className="ms-3">
            <h6 className="mb-0" id="setUsername1">
              {name}
            </h6>
        ...
        <div className="navbar-nav w-120">
            ...
            userLevel > 2 && (
              <>
                <NavLink
                  ...
                  activeclassname="active"
                >
                  <i className="fa fa-pencil-ruler me-2"></i>Admin Bereich
                </NavLink>
                <NavLink
                  ...
                  activeclassname="active"
                >
                  <i className="fa fa-user-alt me-2"></i>Benutzerverwaltung
                </NavLink>
              </>
            )
          }
            ...
            userLevel > 1 && (
              <>
                <NavLink
                  ...
                  activeclassname="active"
                >
                  <i className="fa fa-school me-2"></i>Studiengänge
                </NavLink>
                <NavLink
                  to="/module"
                  className="nav-item nav-link"
                  activeclassname="active"
                >
                  <i className="fa fa-project-diagram me-2"></i>Module
                </NavLink>
                <NavLink
                  to="/kurse"
                  className="nav-item nav-link"
                  activeclassname="active"
                >
                  <i className="fa fa-chalkboard-teacher me-2"></i>Kurse
                </NavLink>
              </>
            )
          }
          ...
          <NavLink
            ...
            activeclassname="active"
          >
            <i className="fa fa-calendar-alt me-2"></i>Kalenderplaner
          </NavLink>
        </div>
      </nav>
    </div>
