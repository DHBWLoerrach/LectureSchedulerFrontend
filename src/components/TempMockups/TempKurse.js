...
const TempKurse = () => {
  ...
  return (
    <div>
      ...
      <br></br>
      <center>
        {!state.shownewDepartmentWidget && <button className="btn btn-primary w-40 m-0" type="button" onClick={handleShownewDepartmentWidget}>Neuen Kurs anlegen</button>}
      </center>
      ...
      <div className="container-fluid pt-4 px-4">
        <div className="bg-light text-center rounded p-4">
          <div className="d-flex align-items-center justify-content-between mb-4">
            <h6 className="mb-0">Alle Kurse</h6>
      ...
      <div className="bg-light text-center rounded p-4">
        ...
        <p className="text-start"><strong>Kurs</strong></p>
        <input
          type="text"
        ...
        />
        <br />
        <p className="text-start"><strong>Zugewiesener (Sekretariat)</strong></p>
        <Select
          options={[{value:"1", label:"Sekretärin 1"},
                    {value:"1", label:"Sekretärin 2"},
                    {value:"1", label:"Sekretärin 3"}
          ]}
          value={""}
          placeholder={""}
        />
