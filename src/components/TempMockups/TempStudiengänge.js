  ...
  return (
    <div>
      ...
      <div className="bg-light text-center rounded p-4">
        ...
        />
        <br />
        <p className="text-start"><strong>Zugewiesene Module (1 Semester)</strong></p>
        <Select
          options={[{value:"1", label:"Mathe I"},
        ...
        />
        <br />
        <p className="text-start"><strong>Zugewiesene Module (2 Semester)</strong></p>
        <Select
          options={[{value:"1", label:"Mathe I"},
                    {value:"1", label:"Mathe II"},
                    {value:"1", label:"Theoretische Informatik I"}
        ...
        />
        <br />
        <p className="text-start"><strong>Zugewiesene Module (3 Semester)</strong></p>
        <Select
          options={[{value:"1", label:"Mathe I"},
                    {value:"1", label:"Mathe II"},
                    {value:"1", label:"Theoretische Informatik I"}
        ...
        />
        <br />
        <p className="text-start"><strong>Zugewiesene Module (4 Semester)</strong></p>
        <Select
          options={[{value:"1", label:"Mathe I"},
                    {value:"1", label:"Mathe II"},
                    {value:"1", label:"Theoretische Informatik I"}
        ...
        />
        <br />
        <p className="text-start"><strong>Zugewiesene Module (5 Semester)</strong></p>
        <Select
          options={[{value:"1", label:"Mathe I"},
                    {value:"1", label:"Mathe II"},
                    {value:"1", label:"Theoretische Informatik I"}
        ...
        />
        <br />
        <p className="text-start"><strong>Zugewiesene Module (6 Semester)</strong></p>
        <Select
          options={[{value:"1", label:"Mathe I"},
                    {value:"1", label:"Mathe II"},
                    {value:"1", label:"Theoretische Informatik I"}
