...
export const EditPersonnelWidget = (props) => {
  ...
  const handleEditDepartment = async () => {
    const { employeeFirstname, employeeLastname, employeeEmail, employeeRole } =
    ...
    if (
      ...
      alert(
        'Ohne vollständige Informationen können Mitarbeiter nicht angepasst werden!'
      );
      return;
    }
    ...
    <div className="container-fluid pt-4 px-4">
      <div className="bg-light text-center rounded p-4">
        <div className="d-flex align-items-center justify-content-between mb-4">
          <h6 className="mb-0">
            Bearbeiten: {employee[1] + ' ' + employee[2]}
          </h6>
